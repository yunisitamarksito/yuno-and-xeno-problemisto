...
local function createPCGUI()
    ...
    minBtn.Position = UDim2.new(1, -82, 0.5, -18)
...
task.spawn(function()
    ...
    if HintApp then
        HintApp:hint({
            text = "☀ OMNI XENO PC loaded! Keybinds: T=Trade, Y=Accept, U=Unaccept, P=Add Pet, X=Decline",
            length = 5,
            overridable = true
        })
    end

    print("☀ OMNI XENO PC loaded successfully!")
